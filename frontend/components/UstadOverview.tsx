...
export default function UstadOverview() {
  ...
  const activities = [
    ...
    { id: '3', title: 'Course Milestone Reached', description: '"Quran Foundation" crossed 50 active enrollments!', date: new Date(Date.now() - 86400000).toISOString() },
  ];
    ...
    <motion.div variants={containerVariants} initial="hidden" animate="visible" className="relative z-10 max-w-7xl mx-auto space-y-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <TeacherCard className="lg:col-span-2 group">
          <div className="p-12 sm:p-16 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-14 h-full relative z-10">
            ...
            <div className="flex flex-col gap-4 w-full sm:w-auto shrink-0">
              ...
              <Link href="/dashboard/add-lesson" className="px-10 py-5 bg-white/[0.03] text-slate-300 font-black rounded-full text-center transition-all flex items-center justify-center gap-3 hover:bg-white/[0.08] hover:text-white hover:scale-[1.05] active:scale-95 border border-white/[0.08]">
                ...
                <span className="text-[14px] uppercase tracking-[0.2em]">Add Lesson</span>
              </Link>
            </div>
          </div>
        </TeacherCard>
        ...
        <TeacherCard className="group flex flex-col items-center justify-center text-center p-12">
          ...
          <p className="text-base text-slate-500 font-medium tracking-widest uppercase">Total Active Students</p>
        </TeacherCard>
      </div>
        ...
        <div className="relative z-10">
          ...
          {loading ? (
            ...
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="text-center py-28 border border-dashed border-white/[0.08] rounded-[3rem] bg-white/[0.01]">
              ...
              <p className="text-slate-400 text-xl max-w-lg mx-auto font-light">Student submissions and milestones will appear here.</p>
            </motion.div>
          ) : (
