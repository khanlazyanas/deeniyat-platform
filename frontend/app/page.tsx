...
export default function Home() {
  ...
  return (
    <main ref={containerRef} className="min-h-screen bg-[#020617] text-slate-50 flex flex-col font-sans selection:bg-emerald-500/30 selection:text-emerald-200 overflow-hidden relative">
      ...
      <section className="relative w-full min-h-screen flex flex-col items-center justify-center text-center px-4 sm:px-6 lg:px-8 overflow-hidden pt-20 perspective-[1000px]">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none z-10">
          <motion.div variants={floatAnimation} animate="animate" className="absolute top-1/4 left-1/4 w-2 h-2 bg-emerald-400 rounded-full blur-[2px] shadow-[0_0_15px_rgba(52,211,153,0.8)]"></motion.div>
          <motion.div variants={floatAnimation} animate="animate" style={{ animationDelay: '1.5s' }} className="absolute bottom-1/3 right-1/4 w-3 h-3 bg-teal-400 rounded-full blur-[3px] shadow-[0_0_20px_rgba(45,212,191,0.8)]"></motion.div>
          <motion.div variants={floatAnimation} animate="animate" style={{ animationDelay: '3s' }} className="absolute top-1/3 right-1/3 w-1.5 h-1.5 bg-amber-400 rounded-full blur-[1px] shadow-[0_0_10px_rgba(245,158,11,0.8)]"></motion.div>
        </div>
        ...
        >
          ...
          <motion.div variants={fadeInUp} className="group cursor-default mb-10 inline-flex flex-col items-center gap-2 px-8 py-4 rounded-3xl bg-slate-900/30 border border-amber-500/20 backdrop-blur-2xl shadow-[0_10px_40px_rgba(245,158,11,0.1)] hover:border-amber-400/60 hover:bg-slate-900/50 transition-all duration-700 hover:-translate-y-1">
            ...
            <div className="flex items-center gap-4 mt-1">
              ...
              <span className="text-[10px] sm:text-xs font-bold text-amber-200/70 tracking-[0.3em] uppercase">
          ...
          <h1 className="text-5xl sm:text-7xl md:text-[6rem] font-black text-white tracking-tighter leading-[1.05] mb-8 flex flex-wrap justify-center gap-x-4">
            {["Elevate", "Your", "Spiritual", "Journey"].map((word, i) => (
              <motion.span 
                ...
                className={i >= 2 ? "text-transparent bg-clip-text bg-gradient-to-br from-emerald-300 via-teal-200 to-emerald-500 drop-shadow-[0_0_30px_rgba(52,211,153,0.3)] relative" : ""}
              >
                {word}
                {i === 3 && (
                  <span className="absolute -bottom-3 left-0 w-full h-4 bg-emerald-500/20 blur-xl rounded-full z-0"></span>
                )}
              </motion.span>
            ))}
          </h1>
          ...
          <motion.p variants={fadeInUp} className="max-w-2xl text-lg sm:text-xl text-slate-400 mb-14 leading-relaxed font-light">
            Experience the profound beauty of Deen through an elite, immersive curriculum. Master <strong className="text-slate-100 font-semibold drop-shadow-md">Quran, Fiqh, and Sunnah</strong> with world-class scholars.
          </motion.p>
          ...
          <motion.div variants={fadeInUp} className="flex flex-col sm:flex-row gap-5 w-full sm:w-auto items-center">
            <Link 
              href="/courses" 
              className="relative group px-12 py-5 text-base font-bold text-slate-950 bg-gradient-to-r from-emerald-400 to-teal-500 rounded-full overflow-hidden transition-all duration-500 hover:scale-[1.03] shadow-[0_0_40px_-10px_rgba(52,211,153,0.6)] hover:shadow-[0_0_70px_-15px_rgba(52,211,153,1)] ring-1 ring-white/20"
            >
      ...
      <section className="py-6 border-y border-slate-800/40 bg-slate-900/20 backdrop-blur-md relative z-20 flex overflow-hidden">
        ...
        >
          {[...islamicValues, ...islamicValues, ...islamicValues, ...islamicValues].map((val, idx) => (
            <div key={idx} className="flex items-center mx-8 sm:mx-16">
              <span className="text-emerald-500/80 mr-3 animate-pulse">✦</span>
              <span className="text-2xl font-serif text-slate-200 mr-3 drop-shadow-[0_0_8px_rgba(255,255,255,0.1)]">{val.ar}</span>
              <span className="text-sm font-medium tracking-[0.2em] text-slate-500 uppercase">{val.en}</span>
            </div>
          ))}
        </motion.div>
      </section>
      ...
      <section className="relative py-40 bg-[#020617] z-20 overflow-hidden">
        ...
        >
          ...
          <div className="flex justify-center mb-12 relative">
            <div className="absolute inset-0 bg-emerald-500/20 blur-2xl rounded-full w-20 h-20 mx-auto"></div>
            <div className="w-16 h-16 rounded-2xl bg-[#020617] border border-emerald-500/30 flex items-center justify-center shadow-[0_0_40px_rgba(52,211,153,0.2)] transform rotate-45 relative z-10">
          ...
          <div className="relative bg-gradient-to-b from-slate-900/50 to-slate-900/10 backdrop-blur-2xl border border-slate-800/80 rounded-[3rem] p-10 md:p-20 shadow-[0_0_50px_rgba(0,0,0,0.5)] ring-1 ring-white/5 overflow-hidden">
            {/* Glowing Corner Accents */}
            <div className="absolute -top-32 -left-32 w-64 h-64 bg-emerald-500/20 rounded-full blur-[80px]"></div>
            <div className="absolute -bottom-32 -right-32 w-64 h-64 bg-teal-500/20 rounded-full blur-[80px]"></div>

            <div className="relative z-10 space-y-12">
              {/* Arabic */}
              <h2 className="text-3xl md:text-5xl lg:text-[3.5rem] font-serif text-emerald-400 leading-relaxed font-medium drop-shadow-2xl" dir="rtl" style={{ lineHeight: '1.7' }}>
                مَنْ سَلَكَ طَرِيقًا يَلْتَمِسُ فِيهِ عِلْمًا سَهَّلَ اللَّهُ لَهُ بِهِ طَرِيقًا إِلَى الْجَنَّةِ
              </h2>
              
              <div className="w-32 h-px bg-gradient-to-r from-transparent via-slate-500 to-transparent mx-auto"></div>
              ...
              {/* English */}
              <p className="text-lg md:text-2xl text-slate-400 font-light italic max-w-4xl mx-auto leading-relaxed">
            ...
            <div className="mt-16 flex items-center justify-center gap-6">
              ...
              <p className="text-amber-400 font-bold tracking-[0.25em] uppercase text-sm drop-shadow-[0_0_10px_rgba(245,158,11,0.5)]">Sahih Muslim</p>
      ...
      {/* 3. LUXURY BENTO GRID */}
      <section className="py-32 bg-[#020617] relative z-20 border-t border-slate-900">
        <motion.div 
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <motion.div variants={fadeInUp} whileHover={{ scale: 1.02 }} transition={{ type: "spring", stiffness: 300 }} className="md:col-span-2 group relative bg-slate-900/30 rounded-[2.5rem] p-10 md:p-14 border border-slate-800/80 hover:border-emerald-500/50 hover:bg-slate-900/60 overflow-hidden backdrop-blur-md shadow-2xl ring-1 ring-white/5">
              ...
              <div className="relative z-10 h-full flex flex-col justify-between">
                <div>
                  <div className="w-20 h-20 bg-gradient-to-br from-emerald-400 to-teal-600 rounded-3xl flex items-center justify-center mb-10 shadow-[0_0_40px_rgba(52,211,153,0.4)] group-hover:scale-110 group-hover:rotate-3 transition-transform duration-500 border border-white/20">
                  ...
                  <h3 className="text-4xl font-bold text-white mb-5">Elite Curriculum</h3>
                  <p className="text-slate-400 leading-relaxed max-w-xl text-xl font-light group-hover:text-slate-200 transition-colors">
            ...
            <motion.div variants={fadeInUp} whileHover={{ scale: 1.02 }} transition={{ type: "spring", stiffness: 300 }} className="group relative bg-slate-900/30 rounded-[2.5rem] p-10 border border-slate-800/80 hover:border-amber-500/50 hover:bg-slate-900/60 overflow-hidden backdrop-blur-md shadow-2xl ring-1 ring-white/5">
              ...
              <div className="w-16 h-16 bg-slate-800/80 border border-slate-700 rounded-2xl flex items-center justify-center mb-10 relative z-10 group-hover:bg-amber-500/20 transition-colors duration-500 text-amber-400">
              ...
              <p className="text-slate-400 font-light leading-relaxed relative z-10 group-hover:text-slate-200 transition-colors text-lg">Direct access to authentic, certified Ustads dedicated to your personal growth.</p>
            </motion.div>

            {/* Premium Side Feature 2 */}
            <motion.div variants={fadeInUp} whileHover={{ scale: 1.02 }} transition={{ type: "spring", stiffness: 300 }} className="group relative bg-slate-900/30 rounded-[2.5rem] p-10 border border-slate-800/80 hover:border-blue-500/50 hover:bg-slate-900/60 overflow-hidden backdrop-blur-md shadow-2xl ring-1 ring-white/5">
              ...
              <div className="w-16 h-16 bg-slate-800/80 border border-slate-700 rounded-2xl flex items-center justify-center mb-10 relative z-10 group-hover:bg-blue-500/20 transition-colors duration-500 text-blue-400">
              ...
              <p className="text-slate-400 font-light leading-relaxed relative z-10 group-hover:text-slate-200 transition-colors text-lg">Resume your lessons flawlessly across devices with our cutting-edge cloud tech.</p>
            </motion.div>
            
            {/* Bottom Glow Feature */}
            <motion.div variants={fadeInUp} whileHover={{ scale: 1.01 }} className="md:col-span-3 group bg-gradient-to-r from-emerald-900/40 via-slate-900/60 to-slate-900/40 rounded-[2.5rem] p-10 md:p-16 border border-emerald-900/40 relative overflow-hidden transition-all duration-500 hover:border-emerald-400/60 shadow-[0_30px_60px_-15px_rgba(0,0,0,0.8)] ring-1 ring-white/5">
              ...
              <div className="absolute -inset-full top-0 z-0 block h-full w-1/2 -skew-x-12 transform bg-gradient-to-r from-transparent via-white/5 to-transparent opacity-0 group-hover:animate-shimmer"></div>

              <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-10">
                <div>
                  <h3 className="text-4xl md:text-5xl font-bold text-white mb-6">Master Your Progress</h3>
                  <p className="text-emerald-100/70 max-w-2xl leading-relaxed text-xl font-light">
                    Attendance analytics, assignment tracking, and crystal-clear progress maps to keep your motivation at its peak.
                  </p>
                </div>
                <Link href="/register" className="shrink-0 px-12 py-6 bg-white text-slate-950 font-bold rounded-full shadow-[0_0_40px_rgba(255,255,255,0.15)] hover:shadow-[0_0_60px_rgba(255,255,255,0.5)] hover:scale-105 transition-all duration-300 flex items-center gap-3 text-lg ring-4 ring-white/20">
                  Join the Platform
      ...
      <section className="relative py-48 overflow-hidden bg-[#020617] border-t border-slate-800/50">
        <motion.div 
          animate={{ rotate: 360, scale: [1, 1.2, 1] }}
          transition={{ duration: 120, repeat: Infinity, ease: "linear" }}
          className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[1000px] h-[1000px] bg-emerald-600/10 rounded-full blur-[150px] pointer-events-none"
        />
        ...
        >
          <div className="inline-flex items-center gap-3 px-6 py-2.5 rounded-full bg-emerald-950/80 border border-emerald-800/80 mb-10 backdrop-blur-md shadow-[0_0_30px_rgba(52,211,153,0.15)]">
            <span className="flex h-2.5 w-2.5 rounded-full bg-emerald-400 animate-pulse"></span>
            <span className="text-emerald-300 font-semibold text-sm tracking-widest uppercase">Enrollment Currently Open</span>
          </div>
          <h2 className="text-6xl md:text-8xl font-black text-white mb-10 tracking-tight leading-[1.1]">
            The journey of a lifetime begins here.
          </h2>
          <p className="text-slate-400 mb-14 text-2xl font-light max-w-3xl mx-auto leading-relaxed">
          ...
          <div className="flex justify-center">
            <Link 
              href="/register" 
              className="group relative inline-flex items-center justify-center px-14 py-6 text-xl font-bold text-white bg-emerald-600 rounded-full overflow-hidden transition-all hover:scale-[1.03] shadow-[0_0_50px_-10px_rgba(52,211,153,0.5)] hover:shadow-[0_0_80px_-15px_rgba(52,211,153,1)] border border-emerald-500/50 ring-1 ring-inset ring-white/20"
            >
