  ...
  return (
    ...
    >
      ...
      <div className="p-8 flex flex-col flex-grow relative z-10 bg-gradient-to-t from-[#010206] to-transparent">
        <h3 className="text-2xl font-black text-white mb-6 line-clamp-1 tracking-tighter group-hover:text-emerald-400 transition-colors duration-500 drop-shadow-md">
          {course.title}
        </h3>
