...
// ============================================================================
// PAGE 1: COURSE PLAYER (Learning Studio)
// ============================================================================
...
export function CoursePlayerPage() {
  ...
  if (loading || !mounted) return (
    <div className="min-h-screen pt-24 pb-12 bg-[#010206] flex flex-col items-center justify-center relative perspective-[2000px] overflow-hidden">
      <div className="absolute top-1/4 left-1/4 w-[500px] h-[500px] bg-emerald-600/10 rounded-full blur-[120px] pointer-events-none mix-blend-screen animate-pulse hidden sm:block"></div>
      ...
      <p className="text-emerald-400 font-bold tracking-[0.1em] sm:tracking-[0.2em] uppercase text-xs sm:text-sm z-10">Initializing Studio...</p>
    </div>
  );
  
  // --- PREMIUM ERROR STATE ---
  if (error) return (
    <div className="min-h-screen pt-24 pb-12 bg-[#010206] flex items-center justify-center p-4 sm:p-6 relative overflow-hidden">
      <div className="bg-[#030612]/80 backdrop-blur-xl border border-red-500/30 p-8 sm:p-10 rounded-[2rem] sm:rounded-[2.5rem] text-center max-w-xl w-full shadow-[0_20px_40px_rgba(0,0,0,0.6),inset_0_1px_1px_rgba(255,255,255,0.05)] z-10">
        ...
        <h3 className="text-2xl sm:text-3xl font-black text-white mb-3 sm:mb-4 tracking-tight">System Error</h3>
        <p className="text-slate-400 text-sm sm:text-lg font-light leading-relaxed mb-6 sm:mb-8">{error}</p>
        <button onClick={() => router.push('/dashboard')} className="px-8 sm:px-10 py-3 sm:py-4 bg-white/[0.03] border border-white/[0.08] rounded-full text-slate-300 font-bold hover:bg-white/[0.1] hover:text-white transition-all duration-300 tracking-wide uppercase text-xs sm:text-sm">Return to Dashboard</button>
      </div>
    </div>
  );
  ...
  return (
    <div className="min-h-screen pt-20 sm:pt-24 bg-[#010206] flex flex-col md:flex-row overflow-hidden relative">
      ...
      <div className="flex-1 h-auto md:h-[calc(100vh-6rem)] overflow-y-auto relative bg-transparent custom-scrollbar">
        ...
        <div className="absolute top-0 right-0 w-[400px] h-[400px] sm:w-[600px] sm:h-[600px] bg-emerald-900/10 rounded-full blur-[100px] sm:blur-[140px] pointer-events-none mix-blend-screen animate-[pulse_10s_ease-in-out_infinite] hidden sm:block"></div>
