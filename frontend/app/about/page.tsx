...
export default function AboutPage() {
  ...
  return (
    <main ref={containerRef} className="min-h-screen bg-[#010206] text-slate-50 flex flex-col font-sans selection:bg-emerald-500/30 selection:text-emerald-200 overflow-x-hidden relative perspective-[2000px] pt-32">
      ...
      {/* Ambient Orbs */}
      <motion.div style={{ y: yBg }} className="absolute top-[10%] left-[20%] w-[600px] h-[600px] bg-emerald-900/20 rounded-full blur-[140px] pointer-events-none mix-blend-screen z-0"></motion.div>
      <div className="absolute bottom-[20%] right-[10%] w-[500px] h-[500px] bg-teal-900/10 rounded-full blur-[120px] pointer-events-none mix-blend-screen z-0"></div>

      <motion.div 
        initial="hidden" animate="visible" variants={staggerContainer}
        className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 py-10"
      >
        {/* 1. Header Section */}
        <motion.div variants={fadeInUp} className="text-center max-w-4xl mx-auto mb-28">
          <div className="inline-flex items-center gap-3 px-5 py-2.5 rounded-full bg-white/[0.03] border border-white/[0.08] shadow-[inset_0_1px_1px_rgba(255,255,255,0.05),0_4px_12px_rgba(0,0,0,0.2)] mb-8 backdrop-blur-xl">
            ...
            <span className="text-[11px] font-black text-slate-300 tracking-[0.3em] uppercase">Our Story</span>
          </div>
          <h1 className="text-5xl md:text-7xl font-black text-white tracking-tighter mb-8 leading-[1.05] drop-shadow-xl">
            Bridging <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 via-teal-400 to-blue-500 drop-shadow-[0_0_30px_rgba(52,211,153,0.3)]">Tradition</span> & Tech
          </h1>
        ...
        <motion.div variants={fadeInUp} className="relative mb-32 border-y border-white/[0.04] py-16 bg-gradient-to-r from-transparent via-white/[0.02] to-transparent">
          ...
          <div className="max-w-6xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-8 relative z-10">
            {[
              ...
              <div key={i} className="text-center group cursor-default">
                <h4 className="text-5xl md:text-6xl font-black text-transparent bg-clip-text bg-gradient-to-b from-white to-slate-500 mb-3 drop-shadow-md group-hover:scale-105 transition-transform duration-500">
                  {stat.value}
                </h4>
                <p className="text-emerald-400/80 text-[11px] font-black uppercase tracking-[0.3em] group-hover:text-emerald-400 transition-colors">{stat.label}</p>
              </div>
            ))}
          </div>
        </motion.div>
        ...
        <motion.div variants={staggerContainer} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-32">
          
          <HolographicCard className="p-10 md:p-14 rounded-[2.5rem]">
            <div className="absolute top-0 right-0 w-[400px] h-[400px] bg-emerald-500/10 rounded-full blur-[100px] translate-x-32 -translate-y-32"></div>
            <div className="w-16 h-16 bg-[#040814] border border-white/[0.08] rounded-[1.25rem] flex items-center justify-center mb-10 relative z-10 text-emerald-400 shadow-[0_8px_16px_rgba(0,0,0,0.5),inset_0_1px_1px_rgba(255,255,255,0.05)]">
            ...
            <h3 className="text-4xl font-black text-white mb-6 tracking-tighter drop-shadow-md">Our Mission</h3>
            <p className="text-slate-400 leading-relaxed font-light text-xl relative z-10">
          ...
          <HolographicCard className="p-10 md:p-14 rounded-[2.5rem]">
            <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-teal-500/10 rounded-full blur-[100px] -translate-x-32 translate-y-32"></div>
            <div className="w-16 h-16 bg-[#040814] border border-white/[0.08] rounded-[1.25rem] flex items-center justify-center mb-10 relative z-10 text-teal-400 shadow-[0_8px_16px_rgba(0,0,0,0.5),inset_0_1px_1px_rgba(255,255,255,0.05)]">
              <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" /></svg>
            </div>
            <h3 className="text-4xl font-black text-white mb-6 tracking-tighter drop-shadow-md">Our Vision</h3>
            <p className="text-slate-400 leading-relaxed font-light text-xl relative z-10">
        ...
        <motion.div variants={fadeInUp} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} className="mb-32">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-black text-white mb-6 tracking-tighter">Guided by the Best</h2>
            <div className="w-24 h-1.5 bg-gradient-to-r from-emerald-400 to-transparent mx-auto rounded-full mb-8 shadow-[0_0_15px_rgba(52,211,153,0.8)]"></div>
            <p className="text-slate-400 max-w-2xl mx-auto font-light text-xl">Learn directly from our board of certified scholars who bring decades of traditional teaching experience to the digital realm.</p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={idx} className="bg-[#030612]/60 backdrop-blur-2xl border border-white/[0.04] rounded-[2rem] p-10 flex flex-col items-center text-center hover:bg-white/[0.02] transition-colors duration-500 shadow-[0_16px_32px_rgba(0,0,0,0.5),inset_0_1px_1px_rgba(255,255,255,0.05)] group">
                <div className="w-28 h-28 rounded-full bg-gradient-to-br from-[#060d20] to-[#040814] border border-white/[0.08] flex items-center justify-center text-4xl font-black text-emerald-400 mb-6 shadow-[0_8px_20px_rgba(0,0,0,0.5)] group-hover:scale-110 transition-transform duration-500">
                  {scholar.img}
                </div>
                <h4 className="text-2xl font-bold text-white mb-2 tracking-tight">{scholar.name}</h4>
                <p className="text-emerald-400/90 text-[11px] font-black uppercase tracking-[0.2em] mb-6">{scholar.role}</p>
                <p className="text-slate-400 text-base font-light leading-relaxed">Certified in traditional Islamic sciences with over 15 years of teaching experience.</p>
              </div>
            ))}
          </div>
        </motion.div>
        ...
        <motion.div variants={staggerContainer} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }}>
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-black text-white mb-6 tracking-tighter">Core Values</h2>
            <div className="w-24 h-1.5 bg-gradient-to-r from-emerald-400 to-transparent mx-auto rounded-full mb-12 shadow-[0_0_15px_rgba(52,211,153,0.8)]"></div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-32">
            {[
              ...
              <motion.div variants={fadeInUp} key={i} className="bg-white/[0.02] border border-white/[0.04] p-10 rounded-[2rem] text-center hover:bg-white/[0.04] transition-colors shadow-[inset_0_1px_1px_rgba(255,255,255,0.02)] group">
                <div className="w-16 h-16 mx-auto bg-[#040814] border border-white/[0.08] rounded-[1.25rem] flex items-center justify-center text-emerald-400 mb-8 shadow-[0_8px_16px_rgba(0,0,0,0.5)] group-hover:scale-110 transition-transform duration-500">
                  <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">{val.icon}</svg>
                </div>
                <h4 className="text-2xl font-bold text-white mb-4 tracking-tight">{val.title}</h4>
                <p className="text-slate-400 text-base font-light leading-relaxed">{val.desc}</p>
              </motion.div>
            ))}
          </div>
        </motion.div>
      ...
      <section className="relative py-40 overflow-hidden bg-[#010206] border-t border-white/[0.04] z-20">
        ...
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeInUp} className="relative z-10 max-w-5xl mx-auto px-4 text-center">
          <h2 className="text-5xl md:text-7xl font-black text-white mb-8 tracking-tighter leading-[1.05] drop-shadow-2xl">
            Ready to start your journey?
          </h2>
          <p className="text-slate-400 mb-14 text-xl md:text-2xl font-light max-w-3xl mx-auto leading-relaxed mix-blend-screen">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-6">
            <Link href="/register" className="group relative inline-flex items-center justify-center px-12 py-6 text-[16px] font-black text-white bg-[#030612] rounded-full overflow-hidden transition-all duration-500 hover:scale-[1.05] shadow-[0_24px_48px_rgba(0,0,0,0.6),inset_0_1px_1px_rgba(255,255,255,0.1)] border border-white/[0.1] hover:border-emerald-500/50 uppercase tracking-[0.2em]">
            ...
            <Link href="/courses" className="px-12 py-6 text-[16px] font-bold text-white bg-white/[0.02] backdrop-blur-2xl border border-white/[0.08] rounded-full hover:bg-white/[0.05] hover:border-white/[0.2] transition-all duration-300 shadow-[0_16px_32px_rgba(0,0,0,0.5)] uppercase tracking-[0.2em] active:scale-95">
              Browse Courses
            </Link>
          </div>
        </motion.div>
