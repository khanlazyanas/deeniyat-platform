...
class _MyCoursesScreenState extends State<MyCoursesScreen> {
  ...
  Future<void> fetchMyCourses() async {
    ...
    try {
      ...
      setState(() {
        // Map se safe extraction aur List casting
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        backgroundColor: const Color(0xFF064E3B), // Luxury Emerald
        foregroundColor: const Color(0xFFFDE047), // Gold text
        elevation: 0,
        centerTitle: true,
      ),
      body: isLoading
          ...
          : RefreshIndicator(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  // Enrollment object ke andar 'course' ki details hoti hain
                  ...
                  return Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(color: const Color(0xFFD4AF37).withOpacity(0.3), width: 1.5), // Gold Border
                      boxShadow: [
                                    ...
                                    child: Ink(
                                      ...
                                      child: Container(
                                        ...
                                        child: const Row(
                                          ...
                                          children: [
                                            Text('Resume Learning', style: TextStyle(color: Colors.white, fontSize: 16, fontWeight: FontWeight.bold, letterSpacing: 0.5)),
                                            SizedBox(width: 8),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 24),
            const Text('No Courses Yet', style: TextStyle(fontSize: 24, fontWeight: FontWeight.w900, color: Color(0xFF0F172A), letterSpacing: -0.5)),
            const SizedBox(height: 12),
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                child: const Text('Explore Courses', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
              ),
            ),
          ],
        ),
