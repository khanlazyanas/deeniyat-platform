...
class _MyCoursesScreenState extends State<MyCoursesScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('My Enrolled Courses', style: TextStyle(fontWeight: FontWeight.bold)),
              ...
              : RefreshIndicator(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      final teacherName = course['teacherId'] != null ? course['teacherId']['name'] : 'Unknown Ustad';
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: course['thumbnail'] == null
                                  ? const Center(child: Icon(Icons.play_circle_fill, size: 50, color: Colors.teal))
                                  : null,
                            ),
                                ...
                                children: [
                                    ...
                                    children: [
                                      Row(
                                        children: [
                                          ...
                                          Text(teacherName, style: const TextStyle(color: Colors.black87)),
                                        ],
                                      ),
                                      Container(
                                  ...
                                  SizedBox(
                                    ...
                                    child: ElevatedButton(
                                      onPressed: () {
                                        // TODO: Navigate to Course Content/Lessons Screen
                                      },
